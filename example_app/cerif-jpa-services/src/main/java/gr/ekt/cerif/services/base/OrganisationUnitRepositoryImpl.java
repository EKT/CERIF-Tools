...
public class OrganisationUnitRepositoryImpl implements OrganisationUnitRepository {
	...
	public List<OrganisationView> findAllOrganisations() {
		return organisationUnitCrudRepository.findAllOrganisations();
	}

	@Override
	public List<OrganisationView> findOrganisationByProjectIdAndClassScheme(
			Long id, String classSchemeUri) {
		return organisationUnitCrudRepository.findOrganisationByProjectIdAndClassScheme(id, classSchemeUri);
	}

	@Override
	public OrganisationView findOrganisationById(Long Id) {
		return organisationUnitCrudRepository.findOrganisationById(Id);
	}
