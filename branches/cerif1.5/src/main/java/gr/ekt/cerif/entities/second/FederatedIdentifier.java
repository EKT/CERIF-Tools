...
import gr.ekt.cerif.entities.link.FederatedIdentifier_Classification;
...
public class FederatedIdentifier implements CerifSecondLevelEntity {
	...
	public FederatedIdentifier(Long id, Long instanceId, String fedId,
			...
			Set<FederatedIdentifier_Classification> fedids_classes,
	...
	private Set<FederatedIdentifier_Classification> fedids_classes;	
	...
	/**
	 * @return the fedids_classes
	 */
	public Set<FederatedIdentifier_Classification> getFedids_classes() {
		return fedids_classes;
	}

	/**
	 * @param fedids_classes the fedids_classes to set
	 */
	public void setFedids_classes(Set<FederatedIdentifier_Classification> fedids_classes) {
		this.fedids_classes = fedids_classes;
	}
