...
public class FederatedIdentifier_Classification implements CerifLinkEntity {
	 ...
	 * 
	 */
	public FederatedIdentifier_Classification() {
	 ...
	 * @param fraction
	 */
	public FederatedIdentifier_Classification(Long id,
