 ...
 */
@Entity
@Table(name="cfResProd_Facil", uniqueConstraints=@UniqueConstraint(columnNames={"cfResProdId","cfFacilId","cfClassId","cfStartDate","cfEndDate"}))
public class ResultProduct_Facility implements CerifLinkEntity {

	/**
	 * 
	 */
	private static final long serialVersionUID = -8788097160723329792L;
	 ...
	 * @param fraction
	 */
	public ResultProduct_Facility(ResultProduct resultProduct,
