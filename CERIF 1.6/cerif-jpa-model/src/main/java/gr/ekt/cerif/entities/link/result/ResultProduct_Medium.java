 ...
 */
@Entity
@Table(name="cfResProd_Medium", uniqueConstraints=@UniqueConstraint(columnNames={"cfResProdId","cfMediumId","cfClassId","cfStartDate","cfEndDate"}))
public class ResultProduct_Medium implements CerifLinkEntity {
	 ...
	 * @param fraction
	 */
	public ResultProduct_Medium(ResultProduct resultProduct, Medium medium,
