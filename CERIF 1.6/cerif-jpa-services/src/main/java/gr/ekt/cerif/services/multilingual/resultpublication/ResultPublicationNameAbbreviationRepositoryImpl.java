...
public class ResultPublicationNameAbbreviationRepositoryImpl implements ResultPublicationNameAbbreviationRepository {
	...
	@Override
	public List<ResultPublicationNameAbbreviation> findByResultPublication(
			ResultPublication resultPublication) {
		return resultPublicationNameAbbreviationCrudRepository.findByResultPublication(resultPublication);
	}
