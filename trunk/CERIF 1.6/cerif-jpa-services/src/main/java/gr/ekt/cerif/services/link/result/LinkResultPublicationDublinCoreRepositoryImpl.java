...
public class LinkResultPublicationDublinCoreRepositoryImpl implements
	...
	@Override
	public List<ResultPublication_DublinCore> findByResultPublication(
			ResultPublication resultPublication) {
		return linkResultPublicationDublinCoreCrudRepository.findByResultPublication(resultPublication);
	}
