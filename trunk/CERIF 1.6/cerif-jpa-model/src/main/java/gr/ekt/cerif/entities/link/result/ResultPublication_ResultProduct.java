 ...
 */
@Entity
@Table(name="cfResPubl_ResProd", uniqueConstraints=@UniqueConstraint(columnNames={"cfResPublId", "cfResProdId", "cfClassId", "cfStartDate", "cfEndDate"}))
public class ResultPublication_ResultProduct implements CerifLinkEntity {
	...
	public String toString() {
		return "ResultPublication_ResultProduct [id=" + id
