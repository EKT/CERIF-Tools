...
public class ProjectView {
	...
	private ClassView scientificDomain;
	...
	/**
	 * @return the scientificDomain
	 */
	public ClassView getScientificDomain() {
		return scientificDomain;
	}


	/**
	 * @param scientificDomain the scientificDomain to set
	 */
	public void setScientificDomain(ClassView scientificDomain) {
	...
	public String toString() {
		return "ProjectView [id=" + id + ", acronym=" + acronym + ", title="
				...
				+ startDate + ", endDate=" + endDate + ", scientificDomain="
				+ scientificDomain + ", roleofOrganisation="
